...
class AccountAdmin(admin.ModelAdmin):
    list_display = [
        'code', 'name', 'group', 'branch_display', 'system_tag',
...
class ExpenseVoucherAdmin(admin.ModelAdmin):
    list_display = [
        'voucher_number', 'branch', 'expense_date', 'expense_account',
        'payment_account', 'amount_display', 'payee_recipient', 'payment_method'
    ]
    list_filter = ['payment_method', 'branch', 'expense_account']
...
class BankReconciliationAdmin(admin.ModelAdmin):
    list_display = [
        'bank_account', 'branch', 'statement_date',
