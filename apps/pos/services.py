...
class POSSessionService:
    ...
    def close_shift(cls, session: CashDrawerSession, actual_cash: Decimal, remarks: str = "", verifier=None) -> CashDrawerSession:
        ...
        for est in sales:
            ...
            # FIN-01 FIX: Deduct change returned on this bill from physical cash tendered
        ...
        expected_cash = session.opening_cash + total_cash_sales + total_cash_debt_repayments - returns_sum
